...
import codeMackupImage from '../assets/code-mockup.png';
...
export function Subscribe() {
    ...
    return (
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscriber} className="flex flex-col gap-2 w-full">
                        ...
                        <button 
                            type="submit"
                            disabled={loading}
                            className="mt-4 uppercase py-4 rounded font-bold text-sm bg-green-500 hover:bg-green-700 transition-colors disabled:opacity-50"
                        >
                            Garantir minha vaga
                        </button>
                    </form>
            ...
            <img className="mt-10" src={codeMackupImage} alt="Code Mockup" />
        </div>
    );
}